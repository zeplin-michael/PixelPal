...
CREATE TABLE pet_status (
  ...
  hunger INT DEFAULT 25 CHECK (hunger BETWEEN 0 AND 500000000000000000),
  last_fed_at TIMESTAMP,
  cleanliness INT DEFAULT 25 CHECK (cleanliness BETWEEN 0 AND 500000000000000000),
  last_cleaned_at TIMESTAMP,
  happiness INT DEFAULT 25 CHECK (happiness BETWEEN 0 AND 500000000000000000),
  last_played_at TIMESTAMP,
  energy INT DEFAULT 25 CHECK (energy BETWEEN 0 AND 500000000000000000),
  last_slept_at TIMESTAMP,
  health INT DEFAULT 100 CHECK (health BETWEEN 0 AND 500000000000000000),
